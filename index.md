...
- [x] 兑换港币（参考：吃饭100/天，宿舍~4000/月，开学买日用品等；**第一次工资9月底发**，要准备一个半月的开销）
- [x] 决定出行方案；买票（07.15）
    -  动卧
    ...
    |香港西九龙 | 打的 | 港科校园 | ~1h | ~160(两人) |
    
     \*以上途径深圳的方案也可以从深圳陆路过关，耗时2~2.5h。
    - 其它交通方案根据自己情况决定，参考：
    ```
                     出发
            ┌─────────┼─────────┐
    ...
    ```
    <!--
    ```     ┌─珠海机场(ZHU)─港珠澳大桥┐    家──香港机场(HKG)──机场快线(65HKD)──荃湾线──西铁线──观塘线(彩虹站)──小巴11──HKUST北门     └─深圳机场(SZX)──深圳地铁/机场大巴──福田/罗湖口岸──东铁线─┘    ```
    -->
- [x] 宿舍系统确认（07.20）
- [x] 复印各材料
